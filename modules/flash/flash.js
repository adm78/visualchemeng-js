...
function setup() {
    ...
    console.log("Warning: flash.js: flash_base.png is being fetched from:");
    console.log("https://rawgit.com/adm78/visualchemeng_js/develop/modules/flash/assets/raster/flash_base.png");
    console.log("This needs to be changed prior to merge with master.");
    test();
    // window sizing
