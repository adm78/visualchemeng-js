...
function Ensemble(p=[],world=null,name='',) {
    ...
    */
    ...
    this.empty = function() {
	// Remove all particles from the ensemble.
	this.particles = [];
	this.outliers = 0;
	this.outliers_removed = false;
    };
	...
	*/
	...
	// Translate all particles in the ensemble along the same
	// vector.
	//
	// WARNING: Interaction between MatterParticle objects and
	// Boundary objects may be unpredictable under translation.
	//
	for (i = 0; i < this.particles.length; i++) {
