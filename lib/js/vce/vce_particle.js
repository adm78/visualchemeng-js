...
function Particle(x, y, options) {
    ...
    /* Initialise the particle. 
       ...
       perturbation - the number of pixel to perturb the particle at
                      each update (vector)
    ...
    */
    ...
    this.acc = options.acc; // current acceleration vector
	...
	var dx = xmax*utils.getRandomSigned();
	var dy = ymax*utils.getRandomSigned();
	...
	if (this.buoyancy != 0.0) {
	    this.acc.y = this.acc.y - this.bouyancy;
	};
    };
