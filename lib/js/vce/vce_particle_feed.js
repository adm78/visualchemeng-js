...
function ParticleFeed(x, y, rate, particle_options) {
    ...
    */
    ...
    this.draw_particle_options = function(p) {
	
	// Randomly draw a single options object from a list of
	// partcle_options. If this.particle_options is not an array
	// then the only avaiable particle_options is returned.
