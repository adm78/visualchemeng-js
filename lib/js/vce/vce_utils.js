...
var utils = {
	...
	for (i = 0; i < maxIterations; i++) {
	    ...
	    var x0 = x1
	    var y = f(x0,args);
	    var yprime = this.derivative(f,x0,args)
    ...
    resizePlotlyWidth : function(gd,id,frac=0.33) {
    ...
    resizePlotlyHeight : function(gd,container_id) {
    ...
    resizePlotly : function(container_id) {
	...
	this.resizePlotlyHeight(gd0_node, container_id)
    },
    ...
    get_absolute_coordinates : function(xmax, ymax, img_width, img_height, scaling) {
