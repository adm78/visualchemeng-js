...
//
// Requires:
// - plotly.js or minified equivalent (only selection functions require this library)
//
...
var utils = {
	...
	var sb_ymax = $('#sim_container').outerHeight()*0.97;
	...
	var fig_handle = d3_selection.node();
	return fig_handle;
    },
