...
function Boundary(x, y, w, h, a, world, mode=CENTER) {
    ...
    */
	...
	var x = this.body.position.x+mouseDistance*Math.cos(mouseAngle-this.body.angle);
	var y = this.body.position.y+mouseDistance*Math.sin(mouseAngle-this.body.angle);
	...
	if (this.active) { this.translate(mouseX, mouseY); };
    };
