...
function TwoBodyParticle(options) {
    /* 
       ...
       args, see TwoBodyParticleDefaults. For more particle options
...
function TwoBodyParticleDefaults() {
    // This is an example of a TwoBodyParticle object creation. It
    // should create a body with the a hexagon with attached sphere.
    // Note: you must append a world, x and y attribute to the returned
    // option list to use it in practice.
    var options = {
	particles : [
	    {
		colour : '#008CBA',
