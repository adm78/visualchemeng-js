...
function MultiBodyParticle(particles=[],constraints=[]) {
    // A multi-body particle is a collection of vce_particle.Particle
    // or vce_particle.PhysEngineParticle and associated
    // constraints. It provides the same interface as
